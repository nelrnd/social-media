      ...
      <div className="relative grid grid-cols-2">
        <div className="relative z-10">
          ...
          <label
            htmlFor="discover"
            className={clsx(
              "h-[56px] flex items-center justify-center px-6 py-3 text-center cursor-pointer rounded-lg transition-colors",
        ...
        <div
          className={clsx(
            "bg-subtle h-[56px] w-1/2 absolute top-0 left-0 z-0 transition-transform rounded-lg",
            {
